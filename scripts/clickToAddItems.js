// function will reset the form fields to natural state
...
// function will clear all fields in the form using the clearErrors() function
function resetForm() {
  clearErrors();
...
// function will verify the user's input is expected
